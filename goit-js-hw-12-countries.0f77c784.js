...
inputEl.addEventListener("input", (0, _debounceDefault.default)((e)=>{
    ...
    getCountry(search).then((res)=>{
        ...
        if (res.length > 2 && res.length <= 10) {
            const fewCountries = res.map((elem)=>{
                return `<li>${elem.name.common}</li>`;
            }).join("");
            listEl.innerHTML = fewCountries;
            return;
        }
        if (!res.length) (0, _pnotifyJs.alert)({
            text: "\u0412\u0432\u0435\u0434\u0456\u0442\u044C \u043A\u0440\u0430\u0457\u043D\u0443",
            delay: 1000
        });
        uploadCountry(res);
...
},{"debounce":"7NAJV","@pnotify/core/dist/PNotify.js":"fay4s","@pnotify/mobile/dist/PNotifyMobile.js":"5RXYV","@pnotify/core/dist/BrightTheme.css":"grIyt","@pnotify/core/dist/PNotify.css":"c4y47","lodash":"LUhzz","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7NAJV":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"grIyt":[function() {},{}],"c4y47":[function() {},{}],"LUhzz":[function(require,module,exports,__globalThis) {
/**
 * @license
